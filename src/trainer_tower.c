...
static const struct SinglesTrainerInfo sSingleBattleTrainerInfo[] = {
    ...
    {OBJ_EVENT_GFX_ACE_TRAINER_M,    FACILITY_CLASS_ACE_TRAINER_M_FRLG, MALE},
    {OBJ_EVENT_GFX_ACE_TRAINER_F,    FACILITY_CLASS_ACE_TRAINER_F_FRLG, FEMALE},
...
static const struct DoublesTrainerInfo sDoubleBattleTrainerInfo[] = {
    ...
    {OBJ_EVENT_GFX_ACE_TRAINER_M,    OBJ_EVENT_GFX_ACE_TRAINER_F,    FACILITY_CLASS_COOL_COUPLE_FRLG,  MALE,   FEMALE},
