...
static void PrintItemQuantity(u8 windowId, u32 itemIndex, u8 y)
{
    ...
    xAlign = GetStringRightAlignXOffset(FONT_SHORT_NARROW, gStringVar4, 119);
...
{
    PrintMenuActionTexts(windowId, FONT_SHORT_NARROW, 8, 1, 0, 0x10, gPyramidBagMenu->menuActionsCount, sMenuActions, gPyramidBagMenu->menuActionIds);
...
{
    PrintMenuActionGrid(windowId, FONT_SHORT_NARROW, 8, 1, 56, horizontalCount, verticalCount, sMenuActions, gPyramidBagMenu->menuActionIds);
...
{
    AddTextPrinterParameterized4(windowId, FONT_SHORT_NARROW, x, y, letterSpacing, lineSpacing, sTextColors[colorTableId], speed, src);
}
