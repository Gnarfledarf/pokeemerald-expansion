...
#define FLAG_TUTOR_WATER_GUN                             0x2C1 //commenting so it shows up in the commmit
...
#define FLAG_SYS_CTRL_OBJ_DELETE                                    (SYS_FLAGS + 0x7) //formerly FLAG_SYS_SPECIAL_WILD_BATTLE
